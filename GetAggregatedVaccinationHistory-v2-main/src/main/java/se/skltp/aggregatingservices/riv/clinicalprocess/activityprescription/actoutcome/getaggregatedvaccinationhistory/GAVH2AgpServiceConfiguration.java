...
public class GAVH2AgpServiceConfiguration extends se.skltp.aggregatingservices.configuration.AgpServiceConfiguration {
...
public static final String SCHEMA_PATH = "/schemas/interactions/GetVaccinationHistoryInteraction/GetVaccinationHistoryInteraction_2.0_RIVTABP21.wsdl";
  ...
  public GAVH2AgpServiceConfiguration() {
    ...
    // Set service factory
    setServiceFactoryClass(GAVH2AgpServiceFactoryImpl.class.getName());
    }
