...
public class RequestListFactoryImpl implements RequestListFactory {
    ...
    /**
     * Filtrera svarsposter från i EI (ei-engagement) baserat parametrar i GetAggregatedVaccinationHistory requestet (req).
    ...
    public List<Object[]> createRequestList(QueryObject qo, FindContentResponseType src) {
        ...
        GetVaccinationHistoryType originalRequest = (GetVaccinationHistoryType)qo.getExtraArg();
        Date reqFrom = null;
        Date reqTo = null;
