...
public class GetAggregatedVaccinationHistoryTestConsumer extends AbstractTestConsumer<GetVaccinationHistoryResponderInterface> {
	...
	public void callService(String logicalAddress, String registeredResidentId, Holder<ProcessingStatusType> processingStatusHolder, Holder<GetVaccinationHistoryResponseType> responseHolder) {
