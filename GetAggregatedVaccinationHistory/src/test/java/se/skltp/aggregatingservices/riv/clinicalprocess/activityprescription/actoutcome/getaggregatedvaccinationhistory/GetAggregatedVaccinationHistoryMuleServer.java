...
public class GetAggregatedVaccinationHistoryMuleServer {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // Note: Actually enables the spring-beans-profile
        // "soitoolkit-teststubs" in the file
        // "src/main/app/GetAggregatedVaccinationHistory-common.xml"
        //
        // Arg #3: Start services if true
        // Note: Actually loads all *-service.xml files that are specified in
        // the file "src/main/app/mule-deploy.properties"
        //
