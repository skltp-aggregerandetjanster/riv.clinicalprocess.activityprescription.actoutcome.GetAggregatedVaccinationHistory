...
public class GetAggregatedVaccinationHistoryIntegrationTest extends AbstractAggregateIntegrationTest {
    ...
    public GetAggregatedVaccinationHistoryIntegrationTest() {
    ...
    private List<ProcessingStatusRecordType> doTest(String registeredResidentId, String senderId, String originalConsumerHsaId, String correlationId, int expectedProcessingStatusSize, TestData... testData) {
        ...
        GetAggregatedVaccinationHistoryTestConsumer consumer = new GetAggregatedVaccinationHistoryTestConsumer(DEFAULT_SERVICE_ADDRESS, senderId, originalConsumerHsaId, correlationId);
        ...
        assertEquals(expectedResponseSize, response.getVaccinationMedicalRecord().size());

        for (int i = 0; i < testData.length; i++) {
            final VaccinationMedicalRecordType responseElement = response.getVaccinationMedicalRecord().get(i);
